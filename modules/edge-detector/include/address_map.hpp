...
#else
#define CUSTOM_HW_MEMORY_OFFSET 0x00000000u
#define CUSTOM_SW_MEMORY_OFFSET 0x00000000u //Offset in software memory
...
#define IMG_FILTER_KERNEL_ADDRESS_HI (IMG_FILTER_KERNEL_ADDRESS_LO + IMG_FILTER_KERNEL_SIZE - 1)
...
#define IMG_FILTER_OUTPUT_ADDRESS_HI (IMG_FILTER_OUTPUT_ADDRESS_LO + IMG_FILTER_OUTPUT_SIZE - 1)
...
#define SOBEL_INPUT_0_ADDRESS_HI (SOBEL_INPUT_0_ADDRESS_LO + SOBEL_INPUT_0_SIZE - 1)
...
#define SOBEL_INPUT_1_ADDRESS_HI (SOBEL_INPUT_1_ADDRESS_LO + SOBEL_INPUT_1_SIZE - 1)
...
#define SOBEL_OUTPUT_ADDRESS_HI (SOBEL_OUTPUT_ADDRESS_LO + SOBEL_OUTPUT_SIZE - 1)
...
#define IMG_INPUT_ADDRESS_HI (IMG_INPUT_ADDRESS_LO + IMG_INPUT_SIZE - 1)
...
#define IMG_INPROCESS_A_ADDRESS_HI (IMG_INPROCESS_A_ADDRESS_LO + IMG_INPROCESS_A_SIZE - 1)
...
#define IMG_INPROCESS_B_ADDRESS_HI (IMG_INPROCESS_B_ADDRESS_LO + IMG_INPROCESS_B_SIZE - 1)
...
#define IMG_INPROCESS_C_ADDRESS_HI (IMG_INPROCESS_C_ADDRESS_LO + IMG_INPROCESS_C_SIZE - 1)
...
#define IMG_COMPRESSED_ADDRESS_HI (IMG_COMPRESSED_ADDRESS_LO + IMG_COMPRESSED_SIZE - 1)
...
#define IMG_OUTPUT_ADDRESS_HI (IMG_OUTPUT_ADDRESS_LO + IMG_OUTPUT_SIZE - 1)
...
#define MEMORY_ADDRESS_HI (MEMORY_ADDRESS_LO + MEMORY_SIZE - 1)
